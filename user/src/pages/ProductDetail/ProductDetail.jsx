...
//   const [tempQuantity, setTempQuantity] = useState(0); // State tạm cho quantity
...
//     if (tempQuantity > 0) {
//       await addToCart(id, tempQuantity); // Gọi với quantity
//       setTempQuantity(0);
//       setShowCounter(false);
//     }
//   };

//   const isInCart = cartItems?.[id] && cartItems[id] > 0;

//   return (
//     <div className="product-detail">
//       <button className="back-btn" onClick={() => navigate('/')}>← Quay về</button>
...
//                 {showCounter && (
//                   <>
//                     <div className="temp-counter"> {/* Counter tạm bên cạnh */}
...
//   const handleConfirmAdd = async () => {
//     if (tempQuantity > 0) {
//       await addToCart(id, tempQuantity);
...
//   return (
//     <div className="product-detail">
//       {/* SỬA: Nút back quay lại trang trước thay vì '/' */}
//       <button className="back-btn" onClick={() => navigate(-1)}>← Quay về</button>
//       <div className="product-detail-container">
//         <div className="product-detail-image">
//           {/* SỬA: Thêm /foods/ vào URL để match subfolder uploads/foods/ */}
//           <img src={`${url}/images/foods/${item.image}`} alt={item.name} />
//         </div>
//         <div className="product-detail-info">
//           <div className="product-detail-name-rating">
//             <h2>{item.name}</h2>
