...
const EditProduct = ({ url, product, onClose, onUpdate }) => {
    ...
    try {
        ...
        // Option 1: POST (như hiện tại)
        const response = await axios.post(`${url}/api/food/update`, formData)
        
        // Option 2: PUT với endpoint khác
        // const response = await axios.put(`${url}/api/food/${product._id}`, formData)
        
        // Option 3: Test với API add (xem có hoạt động không)
        ...
        toast.error("Error updating product - Backend may not be updated")
    }
}
