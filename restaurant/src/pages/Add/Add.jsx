...
//     const response = await axios.post(`${localUrl}/api/food/add`, formData, {
//         headers: {
...
const Add = ({url}) => {  // Prop url từ App
    ...
    const onSubmitHandler = async (event) =>{
        ...
        const response = await axios.post(`${url}/api/food/add`, formData, {  // Sử dụng prop url
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        });
