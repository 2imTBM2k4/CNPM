...
export const accept = respond((req) => shipperService.acceptOrder(req.user, req.params.id));
export const pickup = respond((req) => shipperService.pickupOrder(req.user, req.params.id));
export const complete = respond((req) => shipperService.completeOrder(req.user, req.params.id));
